 ...
 * `Decrypt.repeatKey("10010101000101001001", '{"keyrange": [8, 16], "keytries": 2}')`
 *
 * `input` arg must be a string.
 *
...
D.getRepeatKey = function(input, opts) {
  ...
  var keyTries = (opts && opts.keytries) ? opts.keytries : 2
  ...
  sizes.forEach(function(size) {
    ...
    transBlocks.forEach(function(tBlock) {
      key += XOR.findSingle(tBlock, { return: 'key', noUnicode: false })
    })
